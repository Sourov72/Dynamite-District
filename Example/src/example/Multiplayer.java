...
//                        HandlePlayer handler = new HandlePlayer(LobbyController.activePlayer.elementAt((playerID - 1)));
                        System.out.println("heeeeeeeeeelllllloo");
                        //activeHandlers.add(handler);
    ...
    public boolean acceptedClient() {
        try {
            ...
            if(spliced[0].equalsIgnoreCase("PLAYER_ADD")) {
                ...
                Player newPlayer = new Player(playerID, profile, (double)  (rand.nextInt(GameInfo.WorldWidth.getValue() - ((GameInfo.ScreenWidth.getValue()) -100)) + ((GameInfo.ScreenWidth.getValue()) / 2)),  (double) (rand.nextInt(GameInfo.WorldWidth.getValue() - ((GameInfo.ScreenWidth.getValue()) -100)) + ((GameInfo.ScreenHeight.getValue()) / 2)), 5.0, true);
